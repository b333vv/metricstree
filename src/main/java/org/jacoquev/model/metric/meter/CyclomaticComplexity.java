package org.jacoquev.model.metric.meter;
...
public final class CyclomaticComplexity {
    ...
    public static long calculate(PsiElement element) {
        return calculate(element, ACCEPT_ALL);
    }

    public static long calculate(PsiElement element, PsiElementFilter filter) {
        if (element == null) {
            return 1;
        }
