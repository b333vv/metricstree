...
public abstract class ModelBuilder {
    ...
    protected boolean isMetricEnabled(@NotNull Project project, @NotNull MetricType type) {
    ...
    protected void addMaintainabilityIndexForMethod(MethodElement javaMethod) {
