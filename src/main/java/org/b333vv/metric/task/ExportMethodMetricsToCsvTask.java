...
public class ExportMethodMetricsToCsvTask extends Task.Backgroundable {
    ...
    private static final String FINISHED_MESSAGE = "Export method level metrics to .csv finished";
    private static final String CANCELED_MESSAGE = "Export method level metrics to .csv canceled";
...
//        MetricsUtils.instance().notify("Method level metrics have been successfully exported to " + fileName, myProject);
    }
