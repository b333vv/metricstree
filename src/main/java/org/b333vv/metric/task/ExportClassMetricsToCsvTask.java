...
public class ExportClassMetricsToCsvTask extends Task.Backgroundable {
    ...
    public ExportClassMetricsToCsvTask(Project project, String fileName) {
        super(project, "Export Class Level Metrics To CSV");
