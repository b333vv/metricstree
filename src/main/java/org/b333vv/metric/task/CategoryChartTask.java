...
public class CategoryChartTask extends Task.Backgroundable {
    ...
    public CategoryChartTask() {
        super(MetricsUtils.getCurrentProject(), "Building Category Chart");
    }
    ...
    public void run(@NotNull ProgressIndicator indicator) {
        ...
        if (classesByMetricTypes == null || categoryChart == null) {
            ...
            MetricTaskCache.instance().putUserData(MetricTaskCache.CLASSES_BY_METRIC_TYPES_FOR_CATEGORY_CHART, classesByMetricTypes);
            MetricTaskCache.instance().putUserData(MetricTaskCache.CATEGORY_CHART, categoryChart);
        }
    }
