...
public class ClassLevelFitnessFunctionList {
    private final Model model;
    private final JBScrollPane panel;
    private final JBTable table;
    private Map<FitnessFunction, Integer> byProfileFoundedClassesCount;
    private final Project project;

    public ClassLevelFitnessFunctionList(Project project) {
        ...
        table.getSelectionModel().addListSelectionListener(event -> {
            if (table.getSelectedRow() >= 0) {
                ...
                FitnessFunction profile = (FitnessFunction) selectedCell;
    ...
    private class Model extends AbstractTableModel {
        ...
        public Object getValueAt(int row, int column) {
            FitnessFunction profile = rows.get(row);
            switch (column) {
                case 0:
                ...
                case 1:
                    return profile;
                case 2:
                    return getProfileStructure(profile.profile());
                default:
                    return "";
            }
        }
