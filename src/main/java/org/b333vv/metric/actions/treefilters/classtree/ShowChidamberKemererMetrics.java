...
public class ShowChidamberKemererMetrics extends AbstractToggleAction {
    ...
    public boolean isSelected(@NotNull AnActionEvent e) {
        return e.getProject().getService(UIStateService.class).getClassMetricsTreeFilter().isChidamberKemererMetricsSetVisible();
    }

    @Override
    public void setSelected(@NotNull AnActionEvent e, boolean state) {
        e.getProject().getService(UIStateService.class).getClassMetricsTreeFilter().setChidamberKemererMetricsSetVisible(state);
