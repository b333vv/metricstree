...
public class ShowLiHenryMetrics extends AbstractToggleAction {
    ...
    public boolean isSelected(@NotNull AnActionEvent e) {
        return e.getProject().getService(UIStateService.class).getClassMetricsTreeFilter().isLiHenryMetricsSetVisible();
    }

    @Override
    public void setSelected(@NotNull AnActionEvent e, boolean state) {
        e.getProject().getService(UIStateService.class).getClassMetricsTreeFilter().setLiHenryMetricsSetVisible(state);
