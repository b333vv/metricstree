...
public class ProjectTreeGroupMetricsByMetricSets extends ToggleAction {
    ...
    public boolean isSelected(@NotNull AnActionEvent e) {
        return MetricsUtils.getProjectMetricsTreeFilter().isMetricsGroupedByMetricSets();
    }

    @Override
    public void setSelected(@NotNull AnActionEvent e, boolean state) {
        MetricsUtils.getProjectMetricsTreeFilter().setMetricsGroupedByMetricSets(state);
