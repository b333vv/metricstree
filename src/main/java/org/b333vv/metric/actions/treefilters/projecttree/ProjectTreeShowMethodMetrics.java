...
public class ProjectTreeShowMethodMetrics extends AbstractToggleAction {
    ...
    public boolean isSelected(@NotNull AnActionEvent e) {
        return e.getProject().getService(UIStateService.class).getProjectMetricsTreeFilter().isMethodMetricsVisible();
    }

    @Override
    public void setSelected(@NotNull AnActionEvent e, boolean state) {
        e.getProject().getService(UIStateService.class).getProjectMetricsTreeFilter().setMethodMetricsVisible(state);
