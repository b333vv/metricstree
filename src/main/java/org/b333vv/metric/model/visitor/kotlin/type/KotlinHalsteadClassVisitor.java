 ...
 * <p>
 * Halstead metrics are based on the count of operators and operands in source
 * code.
 * This visitor analyzes Kotlin PSI (Program Structure Interface) tree to
 * extract
 * these elements and compute the following metrics:
 * <ul>
 * <li>CHEF (Effort) - Mental effort required to develop/understand the
 * code</li>
 ...
 * <li><b>Destructuring:</b> component operators in destructuring
 * declarations</li>
 * <li><b>Keywords acting as operators:</b> if, when, for, while, do, try,
 * catch, finally, throw, return, break, continue</li>
 * <li><b>Declaration keywords:</b> fun, val, var, class, object, interface,
 * enum, annotation</li>
 * <li><b>Function/method calls:</b> Each distinct function name is counted as a
 * unique operator</li>
 * </ul>
 * 
 ...
 * <li><b>Literals:</b> Numbers (integer, floating-point), booleans (true,
 * false), null</li>
 * <li><b>String literals:</b> String constants and string templates (counted as
 * single operand)</li>
 ...
 * <ul>
 * <li>Lambda expressions: The lambda arrow (->) is counted as operator,
 * parameters and body are analyzed</li>
 * <li>String templates: Entire string (including interpolations) counted as
 * single operand</li>
 * <li>Function calls: Function name is operator, arguments are operands</li>
 * <li>Property access: Dot operator (.) counted separately from property
 * name</li>
 * <li>Qualified expressions: Each level of qualification adds operators</li>
 * <li>When expressions: 'when' keyword and arrow (->) for each branch counted
 * as operators</li>
 * <li>Destructuring: Each component access counted as operator</li>
 * </ul>
 * 
 * @see <a href=
 *      "https://en.wikipedia.org/wiki/Halstead_complexity_measures">Halstead
...
public class KotlinHalsteadClassVisitor extends KotlinClassVisitor {
    ...
    private long vocabulary() {
        return (long) operands.size() + (long) operators.size();
    }
    ...
    private void compute(@NotNull KtElement element) {
        ...
        scope.accept(new KtTreeVisitorVoid() {
