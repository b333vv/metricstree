...
/**
 * Visitor that calculates the Number of Attributes (NOA) metric for Kotlin
 * classes.
 * 
 * <p>
 * The NOA metric counts the total number of attributes (properties with backing
 * fields)
 * in a class, including properties from various Kotlin-specific constructs.
 * </p>
 * 
 * <h2>What is counted in this metric:</h2>
 * <ul>
 * <li><b>Primary constructor properties</b> - properties declared with
 * {@code val} or {@code var}
 ...
 * </ul>
 * </li>
 * <li><b>Companion object properties</b> - static properties with backing
 * fields declared in
 ...
 * </ul>
 * </li>
 * <li><b>Destructuring declarations</b> - componentN functions that access
 * backing fields</li>
 * </ul>
 * 
 ...
 * <li>Computed properties without backing fields (getters that calculate
 * values)</li>
...
public class KotlinNumberOfAttributesVisitor extends KotlinClassVisitor {
    ...
    private void compute(@NotNull KtElement element) {
        ...
        // Count primary constructor properties (val/var parameters) - only for classes
        ...
        if (element instanceof KtClassOrObject) {
            ...
            isInterface = (klassOrObj instanceof KtClass) && ((KtClass) klassOrObj).isInterface();
            KtClassBody body = klassOrObj.getBody();
            if (body != null) {
     ...
     * 
     * <p>
     * A property has a backing field if:
     * </p>
     * <ul>
     ...
     * 
     * <p>
     * Properties that do NOT have backing fields:
     * </p>
     * <ul>
     * <li>Abstract properties</li>
     * <li>Interface properties (unless they have explicit backing through
     * delegation)</li>
    ...
    private boolean hasBackingField(@NotNull KtProperty property, boolean isInterface) {
        ...
        // (unless they have a delegate or are const, but const not allowed in
        // interfaces)
     ...
     * The 'field' keyword is used to access the backing field within custom
     * accessors.
     * 
