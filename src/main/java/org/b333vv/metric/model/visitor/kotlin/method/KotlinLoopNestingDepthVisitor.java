 ...
 * 
 * <p>
 * Loop Nesting Depth measures the maximum depth of nested loop constructs
 * within a function.
 * This metric helps identify complex iterative logic that may be difficult to
 * understand,
 * maintain, and test. Higher nesting depths generally indicate increased
 ...
 * <p>
 * The metric is calculated as the maximum nesting depth encountered across all
 * execution paths in the function. Each nested loop increments the depth
 * counter.
 ...
 * <p>
 * Generally, LND values above 3 indicate code that may benefit from
 * refactoring.
 * Consider extracting nested loops into separate functions or using functional
 * transformations to flatten the logic.
 * 
 * @see <a href="https://www.aivosto.com/project/help/pm-complexity.html">Loop
 *      Nesting Depth Metrics</a>
 */
