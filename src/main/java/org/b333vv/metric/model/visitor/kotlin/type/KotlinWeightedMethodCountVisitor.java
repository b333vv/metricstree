 ...
 * <p>
 * The WMC metric is calculated as the sum of cyclomatic complexities of all
 * methods
 * and method-like constructs in a class. This implementation accounts for
 * Kotlin-specific
 ...
 * <ul>
 * <li><b>Primary constructor</b> - baseline complexity of the primary
 * constructor</li>
 * <li><b>Secondary constructors</b> - complexity of each secondary constructor
 * body</li>
 * <li><b>Init blocks</b> - complexity of each initialization block</li>
 * <li><b>Member functions</b> - complexity of all named functions in the class
 * body</li>
 * <li><b>Property accessors</b> - complexity of getters and setters (both
 * implicit and custom):
 * <ul>
 ...
 * </ul>
 * </li>
 * <li><b>Properties from primary constructor</b> - implicit accessors for
 * val/var parameters</li>
 * <li><b>Nested and companion object members</b> - functions and properties in
 * nested structures</li>
 * <li><b>Data class implicit methods</b> - equals, hashCode, toString, copy,
 ...
 * <li>Properties in companion objects are counted separately within the
 * companion object scope</li>
 * </ul>
 *
...
public class KotlinWeightedMethodCountVisitor extends KotlinClassVisitor {
    ...
    private void compute(@NotNull KtElement element) {
        ...
        // 1. Primary constructor and properties (only for classes)
        KtPrimaryConstructor primary = null;
        if (element instanceof KtClass) {
            KtClass klass = (KtClass) element;
            primary = klass.getPrimaryConstructor();
            if (primary != null) {
        ...
        List<KtAnonymousInitializer> initializers = java.util.Collections.emptyList();
     ...
     * <p>
     * Includes functions, properties with accessors, and recursively handles nested
     * objects.
     * </p>
     *
    ...
    /**
     * Helper method to safely extract complexity value from a visitor for named
     * functions.
     * <p>
    ...
    /**
     * Helper method to safely extract complexity value from a visitor for primary
     * constructors.
     * <p>
     * Reduces code duplication and handles null checks consistently.
     * </p>
    ...
    /**
     * Helper method to safely extract complexity value from a visitor for secondary
     * constructors.
     * <p>
     * Reduces code duplication and handles null checks consistently.
     * </p>
    ...
    /**
     * Helper method to safely extract complexity value from a visitor for init
     * blocks.
     * <p>
     * Reduces code duplication and handles null checks consistently.
     * </p>
     *
     * @param initializer the anonymous initializer (init block) to calculate
     *                    complexity for
     * @return the complexity value, or 0 if metric is unavailable
     */
