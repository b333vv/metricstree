 ...
 * <p>
 * This metric counts all class members that explicitly override inherited members
 * from parent classes or implemented interfaces.
 *
 * <h3>Counted elements:</h3>
 * <ul>
 *   <li><b>Overridden functions:</b> Named functions marked with the {@code override} modifier</li>
 *   <li><b>Overridden properties:</b> Properties (val/var) marked with the {@code override} modifier</li>
 * </ul>
 *
 * <h3>Not counted:</h3>
 * <ul>
 *   <li>Functions and properties without the {@code override} modifier</li>
 *   <li>Members declared in nested or inner classes (each class is measured independently)</li>
 *   <li>Members declared in companion objects (companion objects are separate types)</li>
 *   <li>Abstract function declarations (they don't override, they declare)</li>
 * </ul>
 *
 * <h3>Rationale:</h3>
 * In Kotlin, both functions and properties can be overridden. Unlike Java where only methods
 * can be overridden, Kotlin allows overriding properties, which can have custom accessors.
 ...
 * <ul>
 *   <li><b>NOOM = 0:</b> The class doesn't override any inherited members (base class or final class)</li>
...
public class KotlinNumberOfOverriddenMethodsVisitor extends KotlinClassVisitor {
    ...
    public void visitClass(@NotNull KtClass klass) {
        int overridden = countOverriddenMembers(klass.getBody());
     ...
     * in the class body.
     * <p>
     * This method only processes declarations that are direct children of the class.
     ...
     * @return count of overridden members (functions + properties), 0 if body is null
     */
    private int countOverriddenMembers(KtClassBody body) {
        if (body == null) {
            return 0;
        }
