 ...
 * 
 * <p>
 * The NOL metric counts all loop and iteration constructs within a method or
 * constructor body.
 * This metric helps assess the iterative complexity of code and can indicate
 * potential performance
 * considerations, testing complexity, and cognitive load for code
 * comprehension.
 * 
 * <h2>Counted Loop Constructs</h2>
 * <p>
 * This visitor counts the following loop constructs:
 * 
 * <h3>Traditional Loops</h3>
 * <ul>
 * <li><b>for loops</b>: Kotlin for-in iteration loops over ranges, collections,
 * and iterables
 * 
 * <pre>{@code for (item in collection) { ... }}</pre>
 * 
 * </li>
 * <li><b>while loops</b>: Conditional loops with entry condition
 * 
 * <pre>{@code while (condition) { ... }}</pre>
 * 
 * </li>
 * <li><b>do-while loops</b>: Conditional loops with exit condition
 * 
 * <pre>{@code do { ... } while (condition)}</pre>
 * 
 * </li>
 * </ul>
 * 
 ...
 * <h2>Not Counted</h2>
 * <p>
 * The following are <b>NOT</b> counted as loops:
 * <ul>
 * <li>Recursion (recursive function calls)</li>
 * <li>Sequences (lazy evaluation constructs like {@code sequence { ... }})</li>
 * <li>Non-iterating higher-order functions (e.g., {@code let}, {@code apply},
 * {@code also}, {@code run}, {@code with})</li>
 * <li>Single-element access operations (e.g., {@code find}, {@code first},
 * {@code last}, {@code single})</li>
 * <li>Aggregation operations without explicit iteration (e.g., {@code count()},
 * {@code sum()}, {@code average()})</li>
 * </ul>
 * 
 * <h2>Metric Calculation</h2>
 * <p>
 * The metric is calculated as the total count of all loop constructs (both
 * traditional and functional)
 * found in the method or constructor body. Nested loops are each counted
 * individually.
 * 
 * <h2>Examples</h2>
 * 
 ...
 * 
 * <p>
 * Consider refactoring methods with high NOL values by:
 * <ul>
 ...
 * </ul>
 * 
 * @see KotlinLoopNestingDepthVisitor for measuring maximum nesting depth of
 *      loops
 * @see <a href="https://www.aivosto.com/project/help/pm-complexity.html">Code
...
public class KotlinNumberOfLoopsVisitor extends KotlinMethodVisitor {
    ...
    public void visitAnonymousInitializer(@NotNull KtAnonymousInitializer initializer) {
        metric = Metric.of(NOL, countLoops(initializer.getBody()));
    }

    /**
     * Counts all loop constructs (traditional and functional) within the given
     * expression.
     * 
    ...
    private long countLoops(KtExpression body) {
        ...
        body.accept(new KtTreeVisitorVoid() {
            ...
            /**
             * Checks if the call expression has lambda arguments, indicating an iteration
             * operation.
             * 
