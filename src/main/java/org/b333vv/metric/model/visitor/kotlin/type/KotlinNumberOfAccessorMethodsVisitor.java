...
/**
 * Visitor for calculating the Number Of Accessor Methods (NOAC) metric for
 * Kotlin classes.
 * 
 * <p>
 * The NOAC metric measures the total number of property accessor methods
 * (getters and setters)
 * in a class. In Kotlin, this includes both explicit and implicit accessors
 * that generate actual
 * bytecode methods.
 * </p>
 * 
 * <h3>What is counted:</h3>
 * <ul>
 * <li><b>Custom getter bodies:</b> Properties with explicitly defined getter
 * implementation
 * (e.g., {@code get() = field * 2})</li>
 * <li><b>Custom setter bodies:</b> Properties with explicitly defined setter
 * implementation
 * (e.g., {@code set(value) { field = value.trim() }})</li>
 * <li><b>Delegated properties:</b> Properties using delegation via the
 * {@code by} keyword,
 * which generate accessor methods delegating to the delegate object</li>
 * <li><b>Accessors with custom visibility:</b> Getters or setters with explicit
 * visibility
 * modifiers (e.g., {@code private set}), as they generate separate methods</li>
 * <li><b>Annotated accessors:</b> Getters or setters with annotations (e.g.,
 * {@code @JvmName}),
 * which typically generate distinct accessor methods</li>
 * <li><b>Lateinit properties:</b> {@code lateinit var} properties generate
 * special accessor
 * methods with initialization checks</li>
 * <li><b>Companion object properties:</b> All properties declared in companion
 * objects,
 ...
 * <ul>
 * <li>Simple properties with default (implicit) getters and setters without any
 * customization</li>
 ...
 * <h3>Rationale:</h3>
 * <p>
 * This metric helps identify classes with high accessor complexity. Kotlin's
 * property syntax
 * can hide the fact that accessor methods are being generated. A high NOAC
 * value may indicate:
 * </p>
 * <ul>
 * <li>Complex property logic that could be refactored into separate
 * methods</li>
...
public class KotlinNumberOfAccessorMethodsVisitor extends KotlinClassVisitor {
    ...
    private void compute(@NotNull KtElement element) {
        ...
        if (element instanceof KtClassOrObject) {
            ...
            // Process companion object (only for classes)
        ...
        count += countAccessorsInDeclarations(declarations);
