...
/**
 * Visitor that counts Non-Commenting Source Statements (NCSS) for Kotlin
 * classes.
 * 
 * <p>
 * The NCSS metric measures the size of source code by counting executable
 * statements,
 * declarations, and control flow constructs while excluding comments and
 * whitespace.
 * This implementation is adapted for Kotlin's language features and PSI
 * structure.
 * 
 ...
 * <ul>
 * <li><b>Class declarations</b> - regular classes, data classes, sealed
 * classes, enum classes</li>
 ...
 * <ul>
 * <li><b>Properties</b> - val/var declarations (including delegated
 * properties)</li>
 * <li><b>Destructuring declarations</b> - val (x, y) = pair</li>
 * <li><b>Named functions</b> - regular functions, extension functions, operator
 * functions</li>
 ...
 * <li><b>Conditional statements</b> - if expressions (else branches counted
 * separately)</li>
 * <li><b>When expressions</b> - each when entry (case) is counted</li>
 * <li><b>Jump statements</b> - return, throw, break, continue (including
 * labeled variants)</li>
 * <li><b>Try-catch-finally</b> - each catch clause and finally block counted
 * separately</li>
 * </ul>
 * 
 * <h3>Expressions as Statements</h3>
 * <ul>
 * <li><b>Assignment expressions</b> - all assignment operators (=, +=, -=,
 * etc.)</li>
 * <li><b>Unary operations</b> - prefix/postfix increment/decrement (++, --) as
 * statements</li>
 * <li><b>Call expressions</b> - function/method calls at statement level</li>
 * <li><b>Qualified expressions</b> - property access and method calls with
 * receivers</li>
 ...
 * <p>
 * This visitor traverses the Kotlin PSI tree and accumulates statement counts.
