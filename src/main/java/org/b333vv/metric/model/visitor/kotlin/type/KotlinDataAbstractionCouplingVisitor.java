 ...
 * 
 * <p>
 * This visitor calculates the Data Abstraction Coupling metric for Kotlin
 * classes,
 * which measures the number of distinct Abstract Data Types (ADTs) used as
 * attribute types.
 * Higher DAC values indicate greater coupling complexity and potentially
 * reduced reusability.
 * 
 * <h2>Metric Scope</h2>
 ...
 * <li><b>Delegated properties</b> - types of delegate expressions (e.g., by
 * lazy, by observable)</li>
 * <li><b>Custom getter return types</b> - explicit return types of property
 * getters</li>
 * <li><b>Generic type parameters</b> - recursively extracted from parameterized
 * types
 ...
 * <li>Primitive types and their wrappers (handled by standard library
 * exclusion)</li>
 * </ul>
 * 
 * <h2>Examples</h2>
...
public class KotlinDataAbstractionCouplingVisitor extends KotlinClassVisitor {
    ...
    private void compute(@NotNull KtElement element) {
        ...
        // Primary constructor properties (val/var parameters) - only for classes
     ...
     * @param selfName the fully qualified name of the current class (to exclude
     *                 self-references)
     */
    ...
    /**
     * Extracts types from Kotlin expressions, particularly useful for delegate
     * expressions
                ...
                if (calleeExpr instanceof KtSimpleNameExpression) {
                    try {
                        ...
                        if (target instanceof KtClass) {
                            ...
                            if (qName != null && !isStandardClass(qName)
                                    && (selfName == null || !qName.equals(selfName))) {
                                sink.add(qName);
                            }
                        }
                    } catch (Exception e) {
     ...
     * @return true if the class is from standard library (java.*, kotlin.*,
     *         javax.*), false otherwise
     */
