...
public class JavaParserNumberOfOperationsVisitorTest extends BaseVisitorTest {

    @Test
    public void testNOO() throws IOException {
        ...
        JavaParserNumberOfOperationsVisitor visitor = new JavaParserNumberOfOperationsVisitor();
