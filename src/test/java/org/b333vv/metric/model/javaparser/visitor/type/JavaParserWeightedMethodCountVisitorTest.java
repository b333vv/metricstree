...
public class JavaParserWeightedMethodCountVisitorTest extends BaseVisitorTest {

    @Test
    public void testWMC() throws IOException {
        ...
        JavaParserWeightedMethodCountVisitor visitor = new JavaParserWeightedMethodCountVisitor();
