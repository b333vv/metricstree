...
public class JavaParserDataAbstractionCouplingVisitorTest extends BaseVisitorTest {

    @Test
    public void testDAC() throws IOException {
        ...
        JavaParserDataAbstractionCouplingVisitor visitor = new JavaParserDataAbstractionCouplingVisitor();
