...
public class JavaParserCouplingIntensityVisitorTest extends BaseVisitorTest {
    ...
    public void testCINT() throws IOException {
        ...
        JavaParserCouplingIntensityVisitor visitor = new JavaParserCouplingIntensityVisitor();
